...
public class ParalaxScrolling : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 parallaxPosistion = new Vector3(transform.position.x + (deltaCameraPosition.x * parallaxFactor), transform.position.y, transform.position.x);
        transform.position = parallaxPosistion;
        prevCameraPosition = cameraTransform.position;
